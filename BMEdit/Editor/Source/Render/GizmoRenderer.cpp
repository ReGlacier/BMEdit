...
namespace render
{
        ...
        void GizmoRenderer::addAABB(const gamelib::BoundingBox& box, const glm::vec4& color)
        {
                ...
                {
                        m_tris.push_back({p[a], color});
                        m_tris.push_back({p[b], color});
                        m_tris.push_back({p[c], color});
                };
                tri(0,1,2); tri(2,1,3);
                tri(4,6,5); tri(5,6,7);
                tri(0,4,1); tri(1,4,5);
